                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="Monthly pay" v-model="model.monthly_pay" class="form-control" placeholder="Enter your monthly pay">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="business_website" v-model="model.business_website" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" v-validate="'required'" name="Business phone" v-model="model.business_phone" class="form-control" placeholder="Enter business phone number">
