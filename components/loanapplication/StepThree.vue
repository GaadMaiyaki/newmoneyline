                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                <span class="pull-left mr-5"><input name="Tenure" v-model="model.tenure" value="4" type="radio" class="form-control"> <b>4 months</b></span>
                                <span class="pull-left mr-5"><input name="Tenure" v-model="model.tenure" value="5" type="radio" class="form-control"> <b>5 months</b></span>
                                <span class="pull-left mr-5"><input name="Tenure" v-model="model.tenure" value="6" type="radio" class="form-control"> <b>6 months</b></span>
                                <span class="pull-left mr-5"><input name="Tenure" v-model="model.tenure" value="7" type="radio" class="form-control"> <b>7 months</b></span>
                                <span class="pull-left mr-5"><input name="Tenure" v-model="model.tenure" value="8" type="radio" class="form-control"> <b>8 months</b></span>
                                <span class="pull-left mr-5"><input name="Tenure" v-model="model.tenure" value="9" type="radio" class="form-control"> <b>9 months</b></span>
                                <span class="pull-left mr-5"><input name="Tenure" v-model="model.tenure" value="10" type="radio" class="form-control"> <b>10 months</b></span>
                                <span class="pull-left mr-5"><input name="Tenure" v-model="model.tenure" value="11" type="radio" class="form-control"> <b>11 months</b></span>
                                <span class="pull-left mr-5"><input name="Tenure" v-model="model.tenure" value="12" type="radio" class="form-control"> <b>12 months</b></span>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="Affordable repayment" v-model="model.monthly_repayment" v-validate="'required|numeric'" class="form-control" placeholder="Enter affordable monthly repayment">
