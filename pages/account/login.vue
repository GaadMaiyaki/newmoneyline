    ...
    <div class="form-wrapper">
      ...
      <b-card style="box-shadow: 0px 0px 9px #f3f3f3; border: 0">
        <b-form @submit="submitForm" v-if="show">
          ...
          <b-form-group>
          <nuxt-link  class="float-right" to="/account/forgot-password">Forgot Password ? </nuxt-link>
          </b-form-group>
          <b-form-group>
            <b-button
              block
      ...
      if (this.login.email && this.login.password) {
        ...
        this.$axios
          ...
          .then(response => {
            ...
            this.$axios.setHeader("Authorization", `${loggedDetails.token}`);
            this.$store.dispatch("auth/authenticate", loggedDetails);
