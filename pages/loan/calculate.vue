      ...
      <b-container fluid>
        ...
        <div class="loan-calculator-wrapper">
          ...
          <div class="text-center" style="margin-top: 2em">
            ...
            >Continue</b-button> -->
            <a href="http://167.71.84.100/add-client">
               <b-button
                variant="primary"
                size="lg"
                style="width: 60%"
...
export default {
  ...
  methods: {
    ...
    //this might be where i have to make the changes for interest
    getCompoundInterest(value) {
      //old value is 0.068 which is 6.8% normally
      //new values is 0.0399 which 3.99% normally
      return (value += Math.round(value * 0.0399, 1));
    },
